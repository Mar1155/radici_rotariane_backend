...
from .views import (
    ...
    create_club_stub, club_members, club_sister_clubs
)
...
urlpatterns = [
    ...
    path('email-verification/request/', email_verification_request, name='email-verification-request'),
    path('email-verification/confirm/', email_verification_confirm, name='email-verification-confirm'),
    ...
    path('<int:club_id>/members/', club_members, name='club-members'),
    path('<int:club_id>/sister-clubs/', club_sister_clubs, name='club-sister-clubs'),
