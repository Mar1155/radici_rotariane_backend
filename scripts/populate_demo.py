...
from users.models import Skill, SoftSkill, User


def remove_international_clubs():
    clubs_to_remove = [
        "rc_newyork",
        "rc_london",
        "rc_paris",
    ...
    clubs_data = [
        {
            ...
            "bio": (
                "<p>Il Rotary Club Milano, fondato nel 1923, è il primo club in Italia. "
                "Impegnato in progetti di servizio locali e internazionali.</p>"
            ),
        },
        {
            "username": "rc_roma",
            ...
            "bio": (
                "<p>Il Rotary Club Roma è uno dei più antichi e prestigiosi d'Italia, "
                "attivo nella promozione della cultura e del servizio umanitario.</p>"
            ),
        },
        {
            "username": "rc_torino",
            ...
            "bio": (
                "<p>Il Rotary Club Torino promuove l'etica professionale e la solidarietà "
                "sociale nel capoluogo piemontese.</p>"
            ),
        },
        {
            "username": "rc_napoli",
            ...
            "bio": (
                "<p>Il Rotary Club Napoli è impegnato in numerose iniziative per la "
                "valorizzazione del territorio e il supporto alle fasce deboli.</p>"
            ),
        },
        {
            "username": "rc_firenze",
            ...
            "bio": (
                "<p>Il Rotary Club Firenze unisce professionisti e leader per servire "
                "la comunità nella culla del Rinascimento.</p>"
            ),
        },
        {
            "username": "rc_bologna",
            ...
            "bio": (
                "<p>Il Rotary Club Bologna sostiene progetti educativi e culturali "
                "nella storica città universitaria.</p>"
            ),
        },
        {
            "username": "rc_venezia",
            ...
            "bio": (
                "<p>Il Rotary Club Venezia si dedica alla salvaguardia del patrimonio "
                "artistico e ambientale della laguna.</p>"
            ),
        },
        {
            "username": "rc_genova",
            ...
            "club_sister_clubs_count": 5,
            "bio": (
                "<p>Il Rotary Club Genova opera attivamente per il benessere della "
                "comunità ligure e internazionale.</p>"
            ),
        },
        {
            "username": "rc_palermo",
            ...
            "club_sister_clubs_count": 4,
            "bio": (
                "<p>Il Rotary Club Palermo promuove lo sviluppo sociale ed economico "
        ...
        },
        {
            ...
            "bio": (
                "<p>Il Rotary Club Bari è un punto di riferimento per il servizio e "
                "l'amicizia nel capoluogo pugliese.</p>"
            ),
        },
    ]
...
def main():
    parser = argparse.ArgumentParser(description="Populate demo data.")
    parser.add_argument(
        "target",
        choices=["all", "clubs", "skills"],
        nargs="?",
        default="all",
        help="What to populate (default: all).",
    )
    args = parser.parse_args()

    if args.target in ("all", "clubs"):
        remove_international_clubs()
        populate_clubs()
