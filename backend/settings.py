...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,0.0.0.0,192.168.1.161,192.168.1.23,django', cast=Csv())
...
# CORS Settings
CORS_ALLOW_ALL_ORIGINS = True  # Per testing, in produzione limitare
