...
# Csv() su stringa vuota restituisce [''], che invalida l'intera lista:
# si filtrano le voci vuote.
...
AUTO_VERIFY_EMAIL_ON_REGISTER = config('AUTO_VERIFY_EMAIL_ON_REGISTER', default=False, cast=bool)
